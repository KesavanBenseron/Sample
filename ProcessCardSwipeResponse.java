...
public class ProcessCardSwipeResponse {

    public Map<String,String> AdditionalOutputData;
    ...
    public void setAdditionalOutputData(Map<String, String> additionalOutputData) {
    ...
    public double getMagnePrintScore() {
        return MagnePrintScore;
    }

    public void setMagnePrintScore(double magnePrintScore) {
        MagnePrintScore = magnePrintScore;
    }
